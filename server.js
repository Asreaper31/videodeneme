require("express")().listen(80);

const db = require("quick.db");
const discord = require("discord.js");
const client = new discord.Client({ disableEveryone: true });
client.login("ODMxOTAwODE3NTUyMTc5MjEw.YHb-Ag.6m-r0WeOCv07W42LqUXXdyjMCYU");
...
client.on("ready", () => {
  client.user.setActivity(`MaximusClub Uptime`);
  passport.use(
    new Strategy(
      {
        clientID: "831900817552179210",
        clientSecret: "9zuCkq0WleD-NTFcCd_snU2eOypDLyDZ",
        callbackURL: "https://discorduptime.xyz/callback",
        scope: ["identify"]
      },
